package cn.bitlinks.ems.module.system.service.sms;
...
import cn.bitlinks.ems.module.system.framework.sms.core.client.SmsClient;
import cn.bitlinks.ems.module.system.framework.sms.core.client.dto.SmsTemplateRespDTO;
import cn.bitlinks.ems.module.system.framework.sms.core.enums.SmsTemplateAuditStatusEnum;
import cn.bitlinks.ems.framework.test.core.ut.BaseDbUnitTest;
import cn.bitlinks.ems.module.system.controller.admin.sms.vo.template.SmsTemplatePageReqVO;
import cn.bitlinks.ems.module.system.controller.admin.sms.vo.template.SmsTemplateSaveReqVO;
import cn.bitlinks.ems.module.system.dal.dataobject.sms.SmsChannelDO;
import cn.bitlinks.ems.module.system.dal.dataobject.sms.SmsTemplateDO;
import cn.bitlinks.ems.module.system.dal.mysql.sms.SmsTemplateMapper;
import cn.bitlinks.ems.module.system.enums.sms.SmsTemplateTypeEnum;
...
public class SmsTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetSmsTemplatePage() {
        ...
        SmsTemplateDO dbSmsTemplate = randomPojo(SmsTemplateDO.class, o -> { // 等会查询到
            ...
            o.setCode("tudou");
            o.setContent("bitlinks");
            o.setApiTemplateId("bitlinks");
            o.setChannelId(1L);
        ...
        // 测试 code 不匹配
        smsTemplateMapper.insert(ObjectUtils.cloneIgnoreId(dbSmsTemplate, o -> o.setCode("bitlinks")));
        // 测试 content 不匹配
