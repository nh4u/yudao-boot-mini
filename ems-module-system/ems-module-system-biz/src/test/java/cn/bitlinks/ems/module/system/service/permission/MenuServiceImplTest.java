...
import cn.bitlinks.ems.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import cn.bitlinks.ems.module.system.dal.dataobject.permission.MenuDO;
import cn.bitlinks.ems.module.system.dal.mysql.permission.MenuMapper;
import cn.bitlinks.ems.module.system.enums.permission.MenuTypeEnum;
...
import static cn.bitlinks.ems.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("bitlinks").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
