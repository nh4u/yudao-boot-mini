package cn.bitlinks.ems.module.system.service.social;
...
import cn.bitlinks.ems.module.system.api.social.dto.SocialUserBindReqDTO;
import cn.bitlinks.ems.module.system.api.social.dto.SocialUserRespDTO;
import cn.bitlinks.ems.module.system.controller.admin.socail.vo.user.SocialUserPageReqVO;
import cn.bitlinks.ems.module.system.dal.dataobject.social.SocialUserBindDO;
import cn.bitlinks.ems.module.system.dal.dataobject.social.SocialUserDO;
import cn.bitlinks.ems.module.system.dal.mysql.social.SocialUserBindMapper;
import cn.bitlinks.ems.module.system.dal.mysql.social.SocialUserMapper;
import cn.bitlinks.ems.module.system.enums.social.SocialTypeEnum;
...
import static cn.bitlinks.ems.framework.common.util.json.JsonUtils.toJsonString;
...
import static cn.bitlinks.ems.module.system.enums.ErrorCodeConstants.SOCIAL_USER_NOT_FOUND;
...
public class SocialUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testAuthSocialUser_notNull() {
        ...
        SocialUserDO socialUser = randomPojo(SocialUserDO.class,
                o -> o.setType(SocialTypeEnum.GITEE.getType()).setCode("tudou").setState("bitlinks"));
        socialUserMapper.insert(socialUser);
        // 准备参数
        Integer socialType = SocialTypeEnum.GITEE.getType();
        Integer userType = randomEle(SocialTypeEnum.values()).getType();
    ...
    public void testGetSocialUserPage() {
        ...
        SocialUserDO dbSocialUser = randomPojo(SocialUserDO.class, o -> { // 等会查询到
            ...
            o.setNickname("bitlinks");
            o.setOpenid("emsbitlinks");
