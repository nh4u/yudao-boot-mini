...
import cn.bitlinks.ems.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import cn.bitlinks.ems.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import cn.bitlinks.ems.module.system.dal.dataobject.mail.MailTemplateDO;
import cn.bitlinks.ems.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static cn.bitlinks.ems.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("bitlinks")));
        // 测试 code 不匹配
