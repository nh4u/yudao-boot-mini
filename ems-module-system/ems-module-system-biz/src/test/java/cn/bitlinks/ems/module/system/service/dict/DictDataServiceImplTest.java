package cn.bitlinks.ems.module.system.service.dict;

import cn.bitlinks.ems.framework.common.enums.CommonStatusEnum;
import cn.bitlinks.ems.framework.common.pojo.PageResult;
import cn.bitlinks.ems.framework.common.util.collection.ArrayUtils;
import cn.bitlinks.ems.framework.test.core.ut.BaseDbUnitTest;
import cn.bitlinks.ems.module.system.controller.admin.dict.vo.data.DictDataPageReqVO;
import cn.bitlinks.ems.module.system.controller.admin.dict.vo.data.DictDataSaveReqVO;
import cn.bitlinks.ems.module.system.dal.dataobject.dict.DictDataDO;
import cn.bitlinks.ems.module.system.dal.dataobject.dict.DictTypeDO;
import cn.bitlinks.ems.module.system.dal.mysql.dict.DictDataMapper;
...
public class DictDataServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetDictDataList() {
        // mock 数据
        DictDataDO dictDataDO01 = randomDictDataDO().setDictType("bitlinks").setSort(2)
                .setStatus(CommonStatusEnum.ENABLE.getStatus());
        dictDataMapper.insert(dictDataDO01);
        DictDataDO dictDataDO02 = randomDictDataDO().setDictType("bitlinks").setSort(1)
                .setStatus(CommonStatusEnum.ENABLE.getStatus());
        dictDataMapper.insert(dictDataDO02);
        DictDataDO dictDataDO03 = randomDictDataDO().setDictType("bitlinks").setSort(3)
                .setStatus(CommonStatusEnum.DISABLE.getStatus());
        dictDataMapper.insert(dictDataDO03);
        DictDataDO dictDataDO04 = randomDictDataDO().setDictType("bitlinks2").setSort(3)
                .setStatus(CommonStatusEnum.DISABLE.getStatus());
        dictDataMapper.insert(dictDataDO04);
        // 准备参数
        Integer status = CommonStatusEnum.ENABLE.getStatus();
        String dictType = "bitlinks";
    ...
    public void testGetDictDataCountByDictType() {
        // mock 数据
        dictDataMapper.insert(randomDictDataDO(o -> o.setDictType("bitlinks")));
    ...
    public void testGetDictData_dictType() {
        // mock 数据
        DictDataDO dictDataDO = randomDictDataDO().setDictType("bitlinks").setValue("1");
        dictDataMapper.insert(dictDataDO);
        DictDataDO dictDataDO02 = randomDictDataDO().setDictType("bitlinks").setValue("2");
        dictDataMapper.insert(dictDataDO02);
        // 准备参数
        String dictType = "bitlinks";
        String value = "1";
    ...
    public void testParseDictData() {
        // mock 数据
        DictDataDO dictDataDO = randomDictDataDO().setDictType("bitlinks").setLabel("1");
        dictDataMapper.insert(dictDataDO);
        DictDataDO dictDataDO02 = randomDictDataDO().setDictType("bitlinks").setLabel("2");
        dictDataMapper.insert(dictDataDO02);
        // 准备参数
        String dictType = "bitlinks";
        String label = "1";
