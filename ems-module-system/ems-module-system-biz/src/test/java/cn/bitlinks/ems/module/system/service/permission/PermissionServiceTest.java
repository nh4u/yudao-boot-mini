...
import cn.bitlinks.ems.module.system.api.permission.dto.DeptDataPermissionRespDTO;
...
import cn.bitlinks.ems.module.system.dal.dataobject.permission.RoleMenuDO;
import cn.bitlinks.ems.module.system.dal.dataobject.permission.UserRoleDO;
import cn.bitlinks.ems.module.system.dal.dataobject.user.AdminUserDO;
import cn.bitlinks.ems.module.system.dal.mysql.permission.RoleMenuMapper;
import cn.bitlinks.ems.module.system.dal.mysql.permission.UserRoleMapper;
...
public class PermissionServiceTest extends BaseDbUnitTest {
    ...
    public void testHasAnyRoles() {
        try (MockedStatic<SpringUtil> springUtilMockedStatic = mockStatic(SpringUtil.class)) {
            ...
            // 准备参数
            Long userId = 1L;
            String[] roles = new String[]{"bitlinks", "tudou"};
            // mock 用户与角色的缓存
            userRoleMapper.insert(randomPojo(UserRoleDO.class).setUserId(userId).setRoleId(100L));
