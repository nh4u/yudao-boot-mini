...
import cn.bitlinks.ems.module.system.dal.dataobject.dept.PostDO;
...
import cn.bitlinks.ems.module.system.dal.mysql.dept.UserPostMapper;
import cn.bitlinks.ems.module.system.dal.mysql.user.AdminUserMapper;
import cn.bitlinks.ems.module.system.enums.common.SexEnum;
import cn.bitlinks.ems.module.system.service.dept.DeptService;
...
import static cn.bitlinks.ems.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn(success("emsbitlinks"));
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("emsbitlinks");
        ...
        assertEquals("emsbitlinks", user.getPassword());
    ...
    public void testUpdateUserPassword_success() {
        ...
        // 断言
        AdminUserDO user = userMapper.selectById(userId);
        assertEquals("encode:bitlinks", user.getPassword());
    }
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("emsbitlinks"))).thenReturn("java");
    ...
    public void testGetUserListByNickname() {
        // mock 数据
        AdminUserDO user = randomAdminUserDO(o -> o.setNickname("bitlinks"));
        userMapper.insert(user);
        // 测试 nickname 不匹配
