package cn.bitlinks.ems.module.system.controller.admin.oauth2.vo.client;
...
public class OAuth2ClientRespVO {
    ...
    @Schema(description = "应用图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.bitlinks.cn/xx.png")
    private String logo;
    ...
    @Schema(description = "可重定向的 URI 地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.bitlinks.cn")
    ...
    @Schema(description = "附加信息", example = "{bitlinks: true}")
