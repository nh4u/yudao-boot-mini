...
import cn.bitlinks.ems.framework.common.util.cache.CacheUtils;
import cn.bitlinks.ems.framework.common.util.http.HttpUtils;
import cn.bitlinks.ems.framework.common.util.object.BeanUtils;
import cn.bitlinks.ems.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.bitlinks.ems.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.bitlinks.ems.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.bitlinks.ems.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.bitlinks.ems.module.system.dal.dataobject.social.SocialClientDO;
import cn.bitlinks.ems.module.system.dal.mysql.social.SocialClientMapper;
import cn.bitlinks.ems.module.system.dal.redis.RedisKeyConstants;
...
import static cn.bitlinks.ems.framework.common.util.collection.MapUtils.findAndThen;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${ems.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${ems.wxa-subscribe-message.miniprogram-state:formal}")
