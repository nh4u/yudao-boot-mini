...
import cn.bitlinks.ems.framework.tenant.core.util.TenantUtils;
import cn.bitlinks.ems.module.system.controller.admin.permission.vo.role.RoleSaveReqVO;
...
import cn.bitlinks.ems.module.system.convert.tenant.TenantConvert;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 ems.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
