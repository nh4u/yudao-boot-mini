...
import cn.bitlinks.ems.module.system.convert.oauth2.OAuth2OpenConvert;
...
import cn.bitlinks.ems.module.system.util.oauth2.OAuth2Utils;
...
import static cn.bitlinks.ems.framework.common.exception.util.ServiceExceptionUtil.exception0;
import static cn.bitlinks.ems.framework.common.pojo.CommonResult.success;
import static cn.bitlinks.ems.framework.common.util.collection.CollectionUtils.convertList;
import static cn.bitlinks.ems.framework.security.core.util.SecurityFrameworkUtils.getLoginUserId;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://www.bitlinks.cn"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://www.bitlinks.cn"),
