...
public class UserController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("bitlinks").deptId(1L).email("bitlinks@bitlinks.cn").mobile("15601691300")
                        .nickname("bitlinks").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MALE.getSex()).build(),
                UserImportExcelVO.builder().username("bitlinks").deptId(2L).email("bitlinks@bitlinks.cn").mobile("15601701300")
