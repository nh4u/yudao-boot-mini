package cn.bitlinks.ems.framework.env.core.fegin;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import cn.bitlinks.ems.framework.common.util.collection.CollectionUtils;
import cn.bitlinks.ems.framework.env.core.context.EnvContextHolder;
import cn.bitlinks.ems.framework.env.core.util.EnvUtils;
...
public class EnvLoadBalancerClient implements ReactorServiceInstanceLoadBalancer {
    ...
    private Response<ServiceInstance> getInstanceResponse(List<ServiceInstance> instances, String tag) {
        ...
        // TODO bitlinks：https://juejin.cn/post/7056770721858469896 想通网段

        // 随机 + 权重获取实例列表 TODO bitlinks：目前直接使用 Nacos 提供的方法，如果替换注册中心，需要重新失败该方法
