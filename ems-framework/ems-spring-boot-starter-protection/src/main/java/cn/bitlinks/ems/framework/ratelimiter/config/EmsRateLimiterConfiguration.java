package cn.bitlinks.ems.framework.ratelimiter.config;

import cn.bitlinks.ems.framework.ratelimiter.core.aop.RateLimiterAspect;
import cn.bitlinks.ems.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import cn.bitlinks.ems.framework.ratelimiter.core.keyresolver.impl.*;
import cn.bitlinks.ems.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class EmsRateLimiterConfiguration {
