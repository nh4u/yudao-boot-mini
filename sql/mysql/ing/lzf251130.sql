...
INSERT INTO `ydme_ems`.`system_dict_data` (`id`, `sort`, `label`, `value`, `dict_type`, `status`, `color_type`, `css_class`, `remark`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (1699, 9, 'R1AH03J', 'R1AH03J', 'invoice_meter_code', 0, '', '', '', '1', '2025-11-30 10:56:32', '1', '2025-11-30 10:56:32', b'0');
INSERT INTO `ydme_ems`.`system_dict_data` (`id`, `sort`, `label`, `value`, `dict_type`, `status`, `color_type`, `css_class`, `remark`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (1698, 8, 'R1AH02J', 'R1AH02J', 'invoice_meter_code', 0, '', '', '', '1', '2025-11-30 10:56:21', '1', '2025-11-30 10:57:18', b'0');
