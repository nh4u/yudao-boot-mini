...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.bitlinks.ems";
    private static final String ARTIFACT_ID = "ems";
    private static final String PACKAGE_NAME = "cn.bitlinks.ems";
    private static final String TITLE = "燕东能管系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.bitlinks.ems";
        String artifactIdNew = "ems";
        String packageNameNew = "cn.bitlinks.ems";
        String titleNew = "燕东能管系统";
        String projectBaseDirNew = "D:\\IdeaProjects\\ydme-ems"; // 一键改名后，“新”项目所在的目录
