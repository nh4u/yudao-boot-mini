...
public class StandingbookTmplDaqAttrServiceImpl implements StandingbookTmplDaqAttrService {
    ...
    @Override
    public List<StandingbookTmplDaqAttrDO> getPrivateStandingbookAttributeByTypeId(Long typeId, Boolean energyFlag) {
        return standingbookTmplDaqAttrMapper.selectList(
                new LambdaQueryWrapper<StandingbookTmplDaqAttrDO>()
                        .eq(StandingbookTmplDaqAttrDO::getTypeId, typeId)
    ...
    public void saveMultiple(List<StandingbookTmplDaqAttrSaveReqVO> saveReqVOList) {
        ...
        // 找出当前属性列表
        List<StandingbookTmplDaqAttrDO> rawAttrList = getPrivateStandingbookAttributeByTypeId(typeId, energyFlag);
        // 级联删除
    ...
    @Override
    public Map<Long, Long> getEnergyMapping() {
