...
import cn.bitlinks.ems.module.power.controller.admin.report.electricity.vo.ProductionConsumptionStatisticInfoData;
...
public class StandardCoalStructureV2ServiceImpl implements StandardCoalStructureV2Service {
    ...
    public List<List<Object>> getExcelData(StatisticsParamV2VO paramVO) {
        ...
        for (StructureInfo s : statisticsInfoList) {
            ...
            // 处理底部合计
            sumStandardCoatMap.put("sumNum", addBigDecimal(sumStandardCoatMap.get("sumNum"), sumStandardCoal));
