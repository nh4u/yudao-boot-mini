...
import static cn.bitlinks.ems.module.power.enums.ErrorCodeConstants.STANDINGBOOK_ACQUISITION_CRON_FAIL;
import static cn.bitlinks.ems.module.power.enums.ErrorCodeConstants.STANDINGBOOK_ACQUISITION_CRON_UNIT_NOT_EXISTS;
...
public class CronUtils {
    ...
    public static String getCron(Long frequency, Integer frequencyUnit) {
        if (frequency == null || frequency <= 0 || frequencyUnit == null) {
            throw exception(STANDINGBOOK_ACQUISITION_CRON_FAIL);
        }
        ...
        switch (acquisitionFrequencyUnit) {
            ...
            case DAY: // 天
                ...
                break;
            default:
                throw exception(STANDINGBOOK_ACQUISITION_CRON_UNIT_NOT_EXISTS, frequencyUnit);
        }
        return cron;
    }
}