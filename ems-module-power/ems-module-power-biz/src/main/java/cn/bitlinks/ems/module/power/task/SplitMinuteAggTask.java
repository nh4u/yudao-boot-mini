...
//
//                // 每批处理 BATCH_SIZE 条
//                Collection<ScoredEntry<String>> batch = scoredSet.entryRange(0, BATCH_SIZE - 1);
//                if (batch.isEmpty()) {
//                    break;
//                }
//
...
//        if (minutes < 0) return;
//        if (minutes == 0) {
//            minuteAggregateDataFiveMinuteApi.insertDataBatch(Collections.singletonList(dto.getStartDataDO()));
//            return;
//        }
//
...
//            dataList.add(d);
//        }
//        minuteAggregateDataFiveMinuteApi.insertDataBatch(dataList);
//    }
//
//}
