package cn.bitlinks.ems.module.infra.framework.file.core.s3;
...
public class S3FileClientTest {
    ...
    public void testAliyun() throws Exception {
        ...
        config.setBucket("bitlinks-aoteman");
        config.setDomain(null); // 如果有自定义域名，则可以设置。http://ali-oss.bitlinks.cn
        // 默认北京的 endpoint
    ...
    public void testQCloud() throws Exception {
        ...
        config.setDomain(null); // 如果有自定义域名，则可以设置。http://tengxun-oss.bitlinks.cn
        // 默认上海的 endpoint
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.ems.bitlinks.cn"); // 如果有自定义域名，则可以设置。http://static.ems.bitlinks.cn
        // 默认上海的 endpoint
