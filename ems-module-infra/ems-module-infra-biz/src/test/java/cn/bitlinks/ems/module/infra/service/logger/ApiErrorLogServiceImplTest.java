package cn.bitlinks.ems.module.infra.service.logger;
...
import cn.bitlinks.ems.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.bitlinks.ems.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.bitlinks.ems.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.bitlinks.ems.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.bitlinks.ems.framework.common.util.date.LocalDateTimeUtils.*;
...
import static cn.bitlinks.ems.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.bitlinks.ems.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        reqVO.setApplicationName("ems-test");
    ...
    public void testCleanJobLog() {
        ...
        // TODO @bitlinks：createTime updateTime 被屏蔽，仅 win11 会复现，建议后续修复。
