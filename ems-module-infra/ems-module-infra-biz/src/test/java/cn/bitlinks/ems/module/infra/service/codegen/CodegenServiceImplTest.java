package cn.bitlinks.ems.module.infra.service.codegen;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.map.MapUtil;
import cn.bitlinks.ems.framework.common.pojo.PageResult;
import cn.bitlinks.ems.framework.test.core.ut.BaseDbUnitTest;
import cn.bitlinks.ems.module.infra.controller.admin.codegen.vo.CodegenCreateListReqVO;
import cn.bitlinks.ems.module.infra.controller.admin.codegen.vo.CodegenUpdateReqVO;
import cn.bitlinks.ems.module.infra.controller.admin.codegen.vo.column.CodegenColumnSaveReqVO;
import cn.bitlinks.ems.module.infra.controller.admin.codegen.vo.table.CodegenTablePageReqVO;
import cn.bitlinks.ems.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.bitlinks.ems.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import cn.bitlinks.ems.module.infra.dal.dataobject.codegen.CodegenTableDO;
import cn.bitlinks.ems.module.infra.dal.mysql.codegen.CodegenColumnMapper;
import cn.bitlinks.ems.module.infra.dal.mysql.codegen.CodegenTableMapper;
import cn.bitlinks.ems.module.infra.enums.codegen.CodegenFrontTypeEnum;
import cn.bitlinks.ems.module.infra.enums.codegen.CodegenSceneEnum;
import cn.bitlinks.ems.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import cn.bitlinks.ems.module.infra.framework.codegen.config.CodegenProperties;
import cn.bitlinks.ems.module.infra.service.codegen.inner.CodegenBuilder;
import cn.bitlinks.ems.module.infra.service.codegen.inner.CodegenEngine;
import cn.bitlinks.ems.module.infra.service.db.DatabaseTableService;
...
import static cn.bitlinks.ems.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.bitlinks.ems.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.bitlinks.ems.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.bitlinks.ems.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.bitlinks.ems.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.bitlinks.ems.framework.test.core.util.RandomUtils.*;
import static cn.bitlinks.ems.module.infra.enums.ErrorCodeConstants.*;
...
public class CodegenServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateCodegenList() {
        ...
        CodegenCreateListReqVO reqVO = randomPojo(CodegenCreateListReqVO.class,
                o -> o.setDataSourceConfigId(1L).setTableNames(Collections.singletonList("t_bitlinks")));
        // mock 方法（TableInfo）
        TableInfo tableInfo = mock(TableInfo.class);
        when(databaseTableService.getTable(eq(1L), eq("t_bitlinks")))
                .thenReturn(tableInfo);
        when(tableInfo.getComment()).thenReturn("bitlinks");
        ...
        AdminUserRespDTO user = randomPojo(AdminUserRespDTO.class, o -> o.setNickname("bitlinks"));
        ...
        assertEquals("bitlinks", dbTable.getAuthor());
        // 断言（CodegenColumnDO）
    ...
    public void testSyncCodegenFromDB() {
        ...
        CodegenTableDO table = randomPojo(CodegenTableDO.class, o -> o.setTableName("t_bitlinks")
    ...
    public void testGetCodegenTablePage() {
        ...
        CodegenTableDO tableDO = randomPojo(CodegenTableDO.class, o -> {
            o.setTableName("t_bitlinks");
            o.setTableComment("bitlinks");
            o.setClassName("Systembitlinks");
        ...
        reqVO.setTableName("bitlinks");
        reqVO.setTableComment("芋");
        reqVO.setClassName("bitlinks");
    ...
    public void testGetDatabaseTableList() {
        ...
        when(tableInfo01.getName()).thenReturn("t_bitlinks");
        when(tableInfo01.getComment()).thenReturn("bitlinks");
        TableInfo tableInfo02 = mock(TableInfo.class);
        when(tableInfo02.getName()).thenReturn("t_bitlinks_02");
        when(tableInfo02.getComment()).thenReturn("bitlinks_02");
        ...
        // 断言
        assertEquals(1, result.size());
        assertEquals("t_bitlinks", result.get(0).getName());
        assertEquals("bitlinks", result.get(0).getComment());
    }
