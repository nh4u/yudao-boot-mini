package cn.bitlinks.ems.module.infra.service.db;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.ReflectUtil;
import cn.hutool.crypto.symmetric.AES;
import cn.bitlinks.ems.framework.mybatis.core.type.EncryptTypeHandler;
import cn.bitlinks.ems.framework.mybatis.core.util.JdbcUtils;
import cn.bitlinks.ems.framework.test.core.ut.BaseDbUnitTest;
import cn.bitlinks.ems.module.infra.controller.admin.db.vo.DataSourceConfigSaveReqVO;
import cn.bitlinks.ems.module.infra.dal.dataobject.db.DataSourceConfigDO;
import cn.bitlinks.ems.module.infra.dal.mysql.db.DataSourceConfigMapper;
...
import static cn.bitlinks.ems.module.infra.enums.ErrorCodeConstants.DATA_SOURCE_CONFIG_NOT_EXISTS;
...
public class DataSourceConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void setUp() {
        ...
        dataSourceProperty.setUsername("bitlinks");
    ...
    public void testGetDataSourceConfig_master() {
        ...
        assertEquals("bitlinks", dataSourceConfig.getUsername());
    ...
    public void testGetDataSourceConfigList() {
        ...
        assertEquals("bitlinks", dataSourceConfigList.get(0).getUsername());
