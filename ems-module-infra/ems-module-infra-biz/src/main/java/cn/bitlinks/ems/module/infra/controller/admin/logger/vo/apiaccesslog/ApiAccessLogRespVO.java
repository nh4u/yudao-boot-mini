package cn.bitlinks.ems.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(cn.bitlinks.ems.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "bitlinks，牛逼！")
    @ExcelProperty("结果提示")
