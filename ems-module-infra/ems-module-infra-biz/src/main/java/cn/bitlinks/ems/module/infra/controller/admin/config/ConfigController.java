package cn.bitlinks.ems.module.infra.controller.admin.config;
...
import cn.bitlinks.ems.module.infra.enums.ErrorCodeConstants;
...
public class ConfigController {
    ...
    @Parameter(name = "key", description = "参数键", required = true, example = "bitlinks.biz.username")
