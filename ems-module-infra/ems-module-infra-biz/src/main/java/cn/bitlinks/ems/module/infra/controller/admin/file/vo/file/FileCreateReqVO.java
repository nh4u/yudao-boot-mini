package cn.bitlinks.ems.module.infra.controller.admin.file.vo.file;
...
public class FileCreateReqVO {
    ...
    @Schema(description = "文件路径", requiredMode = Schema.RequiredMode.REQUIRED, example = "ems.jpg")
    private String path;

    @NotNull(message = "原文件名不能为空")
    @Schema(description = "原文件名", requiredMode = Schema.RequiredMode.REQUIRED, example = "ems.jpg")
    private String name;
