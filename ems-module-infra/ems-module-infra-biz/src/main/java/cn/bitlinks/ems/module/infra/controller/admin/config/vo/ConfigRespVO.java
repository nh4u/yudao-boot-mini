package cn.bitlinks.ems.module.infra.controller.admin.config.vo;
...
import cn.bitlinks.ems.module.infra.enums.DictTypeConstants;
...
public class ConfigRespVO {
    ...
    @Schema(description = "参数键名", requiredMode = Schema.RequiredMode.REQUIRED, example = "bitlinks.db.username")
    @ExcelProperty("参数键名")
    private String key;
